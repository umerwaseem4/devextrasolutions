...
const Team = () => {
  return (
    <div>
      <section class="container mx-auto px-4 pt-20 pb-10 lg:pt-[120px] lg:pb-20">
        <div class="container mx-auto px-4">
          <div class="-mx-4 flex flex-wrap">
            <div class="w-full px-4">
              <div data-aos="fade-up"
                ...
                <h2 data-aos="fade-up"
                data-aos-delay="100" class="text-dark mb-4 text-3xl font-bold sm:text-4xl md:text-[40px]">
                  Our Awesome Team
                </h2>
                <p data-aos="fade-up"
                data-aos-delay="200" class="text-body-color text-base">
          ...
          <div data-aos="fade-up"
                data-aos-delay="300" class="-mx-4 flex flex-wrap justify-center">
                ...
                <div class="relative overflow-hidden rounded-lg">
                  ...
                  <div class="absolute bottom-5 left-0 w-full text-center">
                    <div class="relative mx-5 overflow-hidden rounded-lg bg-white py-5 px-3">
                      ...
                      <p class="text-body-color text-sm">Founder</p>
                      <div>
                        <span class="absolute left-0 bottom-0">
                          <svg
                            width="61"
